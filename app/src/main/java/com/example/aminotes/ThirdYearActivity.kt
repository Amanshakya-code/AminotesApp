...
class ThirdYearActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        list.add(subject("German (sem 3)",R.color.blue15,"third"))
        list.add(subject("German (sem 4)",R.color.blue16,"third"))
        list.add(subject("Spanish (sem 3)",R.color.blue17,"third"))
        list.add(subject("Spanish (sem 4)",R.color.blue18,"third"))
        list.add(subject("French (sem 3)",R.color.blue19,"third"))
        list.add(subject("French (sem 4)",R.color.blue20,"third"))
        list.add(subject("Japanese (sem 3)",R.color.blue21,"third"))
        list.add(subject("Japanese (sem 4)",R.color.blue22,"third"))
        list.add(subject("Chinese (sem 3)",R.color.blue23,"third"))
        list.add(subject("Chinese (sem 4)",R.color.blue24,"third"))
